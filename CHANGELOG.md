...
### Changed
- Coverage badge total now excludes `cmd/server` (composition root) and
  `pkg/logger` (trivial), which are not meaningfully unit-tested.
...
[Unreleased]: https://github.com/JesusCabreraReveles/kafka-rest-api/compare/v1.1.1...HEAD
[1.1.1]: https://github.com/JesusCabreraReveles/kafka-rest-api/compare/v1.1.0...v1.1.1
